...
The notebook tuto_deep_learning.ipynb is an experimental notebook that only creates a mask-kml file.

The notebook tuto_machine_learning.ipynb is the one to use.
